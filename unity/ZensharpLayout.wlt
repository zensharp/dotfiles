...
MonoBehaviour:
  ...
  m_Position:
    ...
    width: 393
    height: 431
  m_MinSize: {x: 452, y: 226}
  m_MaxSize: {x: 1922, y: 746}
...
MonoBehaviour:
  ...
  m_OverlayCanvas:
    ...
    - dockPosition: 1
      ...
      index: 1
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Folded":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":-223.0,"y":-36.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":3,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: -223, y: -36}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 3
      layout: 4
      size: {x: 0, y: 0}
    ...
    - dockPosition: 2
      ...
      index: 0
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Folded":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":-104.0,"y":-36.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":3,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: -104, y: -36}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 3
      layout: 4
      size: {x: 0, y: 0}
...
MonoBehaviour:
  ...
  m_Enabled: 1
  m_EditorHideFlags: 0
  m_Script: {fileID: 11500000, guid: e463249acaa086446aa9736b39ed055b, type: 3}
  m_Name: 
  m_EditorClassIdentifier: Assembly-CSharp-Editor::Code.Editor.SceneLoaderWindow
  m_MinSize: {x: 450, y: 200}
  m_MaxSize: {x: 1920, y: 720}
  m_TitleContent:
    m_Text: Scene Loader
    m_Image: {fileID: 0}
    m_Tooltip: 
    m_TextWithWhitespace: "Scene Loader\u200B"
  m_Pos:
    serializedVersion: 2
    x: 935
    y: 941
...
MonoBehaviour:
  ...
  m_ZoomArea:
    ...
    m_MinimalGUI: 1
  m_defaultScale: 1
  m_LastWindowPixelSize: {x: 1231, y: 402}
  m_ClearInEditMode: 1
  m_NoCameraWarning: 0
...
MonoBehaviour:
  ...
  m_LastProjectPath: C:\Users\andrew\repos\gitlab.com\projectclef\clef\ProjectClef
  m_LockTracker:
    m_IsLocked: 0
...
MonoBehaviour:
  ...
  m_OverlayCanvas:
    ...
    - dockPosition: 1
      ...
      id: Tool Settings
      index: 0
      contents: '{"m_Layout":1,"m_Collapsed":false,"m_Folded":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":24.0,"y":-14.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":2,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: 24, y: -14}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 2
      layout: 1
      size: {x: 0, y: 0}
    ...
    - dockPosition: 1
      ...
      index: 0
      contents: '{"m_Layout":1,"m_Collapsed":false,"m_Folded":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":-322.0,"y":-24.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":3,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: -322, y: -24}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 3
      layout: 1
      size: {x: 0, y: 0}
    ...
    - dockPosition: 0
      ...
      id: Orientation
      index: 0
      contents: '{"m_Layout":4,"m_Collapsed":false,"m_Folded":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":-111.0,"y":-80.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":3,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
      snapOffset: {x: -111, y: -80}
      snapOffsetDelta: {x: 0, y: 0}
      snapCorner: 3
      layout: 4
      size: {x: 0, y: 0}
    ...
    - dockPosition: 1
      ...
      id: Hot Reload
      index: 10
      contents: '{"m_Layout":1,"m_Collapsed":false,"m_Folded":false,"m_Floating":false,"m_FloatingSnapOffset":{"x":-56.0,"y":-30.0},"m_SnapOffsetDelta":{"x":0.0,"y":0.0},"m_FloatingSnapCorner":3,"m_Size":{"x":0.0,"y":0.0},"m_SizeOverridden":false}'
      floating: 0
      collapsed: 0
  ...
  m_Position:
    m_Target: {x: 0.002555956, y: 1.0921836, z: 0.043047383}
    speed: 2
    m_Value: {x: 1.4633598, y: -4.546402, z: 23.455101}
  m_RenderMode: 0
  m_CameraMode:
    drawMode: 0
    name: Shaded
  ...
  m_Rotation:
    m_Target: {x: -0.07658531, y: -0.40379712, z: -0.034278207, w: 0.9110154}
    speed: 2
    m_Value: {x: -0.3381529, y: 0.27486455, z: -0.10363769, w: -0.89407986}
  m_Size:
    m_Target: 0.27853128
    speed: 2
    m_Value: 12.124355
